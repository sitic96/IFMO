...
public class AddNewBookingServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MongoDBObjectDAO dbObjectDAO = new MongoDBObjectDAO(mongo, "BookingInfo");
        ...
        List<BookingInfo> mongoObjects = dbObjectDAO.readAllMongoObjects("BookingInfo");
    ...
    private Room getRoom(HttpServletRequest request) {
        Room room = new Room(request.getParameter("roomCategory"),
                request.getParameter("roomPricePerNight")
        );
        return room;
    }
